    ...
    theme      : {
        ...
        extend  : {
            ...
            typography: ({theme}) => ({
                DEFAULT: {
                    css: {
                        color              : 'var(--nostr-text-default)',
                        '[class~="lead"]'  : {
                            color: 'var(--nostr-text-secondary)'
                        },
                        a                  : {
                            color: 'var(--nostr-primary-500)'
                        },
                        strong             : {
                            color: 'var(--nostr-text-default)'
                        },
                        ...
                        'ul > li::before'  : {
                            backgroundColor: 'var(--nostr-text-hint)'
                        },
                        hr                 : {
                            borderColor: 'var(--nostr-border)'
                        },
                        blockquote         : {
                            color          : 'var(--nostr-text-default)',
                            borderLeftColor: 'var(--nostr-border)'
                        },
                        h1                 : {
                            color: 'var(--nostr-text-default)'
                        },
                        ...
                        thead              : {
                            color            : 'var(--nostr-text-default)',
                            borderBottomColor: 'var(--nostr-border)'
                        },
                        'tbody tr'         : {
                            borderBottomColor: 'var(--nostr-border)'
                        },
