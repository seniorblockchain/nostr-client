...
export const appRoutes: Route[] = [
    ...
    {path: '', pathMatch : 'full', redirectTo: 'apps/notes'},
    ...
    {path: 'signed-in-redirect', pathMatch : 'full', redirectTo: 'apps/notes'},
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'apps', children: [
                ...
                {path: 'people', loadChildren: () => import('app/modules/admin/apps/contacts/contacts.module').then(m => m.ContactsModule)},
            ...
            {path: 'ui', children: [
                ...
                // Nostr Components
                {path: 'nostr-components', loadChildren: () => import('app/modules/admin/ui/nostr-components/nostr-components.module').then(m => m.NostrComponentsModule)},
