...
import { NostrNavigationItem, NostrNavigationService } from '@theme/components/navigation';
...
{
    private readonly _defaultNavigation: NostrNavigationItem[] = defaultNavigation;
     ...
     */
    constructor(
        private _nostrMockApiService: NostrMockApiService,
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._nostrNavigationService.getFlatNavigation(this._defaultNavigation);
