...
import { NostrMockApiService, NostrMockApiUtils } from '@theme/lib/mock-api';
    ...
    registerHandlers(): void
    {
        ...
        this._nostrMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newList.id = NostrMockApiUtils.guid();
        ...
        this._nostrMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newCard.id = NostrMockApiUtils.guid();
        ...
        this._nostrMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newLabel.id = NostrMockApiUtils.guid();
