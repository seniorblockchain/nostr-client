            ...
            changes    : [
                {
                    type: 'Fixed',
                    list: [
                        '(@theme/confirmation-dialog) Fixed: Extra padding on the confirmation dialogs',
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    type: 'Breaking',
                    list: [
                        '(Dependencies) From this version up, Nostr will not be compatible with Legacy Angular Material components',
                        ...
                        '(.nostr-mat-textarea) Removed in favor of CSS :has selector, now textareas within "mat-form-field" components are detected automatically',
                        '(.nostr-mat-no-subscript) Removed in favor of \'subscriptSizing="dynamic"\' property of "mat-form-field"',
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        '(Dependencies) Updated Angular & Angular Material to v15.0.0',
                        '(Dependencies) Updated various other packages',
                        '(Dependencies) Removed ngx-markdown from the package.json, it still can be used within Nostr, it\'s a part of the effort to make releasing Nostr updates easier',
        ...
        // v16.0.0
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(NostrVerticalNavigation) Fixed: Sticky positioning breaks inside a fixed positioned parent (Firefox)',
        ...
        // v15.2.0
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@theme/tailwind/plugins/theming) Simplified the plugin and added more detailed comments',
        ...
        // v15.1.0
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@theme/overrides/angular-material) mat-hint position is not working correctly on fields'
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(@theme/navigation) Added "fragment" and "queryParams" support along with "preserveFragment" and "queryParamsHandling" on navigation items',
                        '(@theme/overrides/quill) Added tooltip styles for better compatibility',
                        '(@theme/services/platform) Added platform checker service',
                ...
                },
                {
                    ...
                    list: [
                        ...
                        '(NostrDrawer) Updated the overlay and animation handling code for better stability',
                        '(@theme/overrides/quill) Better scrolling for Quill editor',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@theme/navigation) Collapse animation doesn"t work smoothly because of the parent"s margin',
                        '(@theme/service/confirmation) Cleaned-up the dialog component',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(@theme/navigation) Expose the width variables as css custom properties, so they can be overridden from the outside',
                        '(@theme/drawer) Expose the width variable as a css custom property, so it can be overridden from the outside',
                        '(@theme/masonry) Removed the unnecessary scss file'
                    ]
                },
                {
                    type: 'Fixed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(NostrLoadingBar) Added the NostrLoadingBar component, its helper service and its interceptor'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(NostrDateRange) BREAKING: Removed the NostrDateRange component, alternative: https://github.com/fetrarij/ngx-daterangepicker-material'
                    ]
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@theme/overrides/angular-material) Fixed: Normal border color of the text field overrides the invalid and focus border colors on dark themes',
                        '(@theme/navigation) Don\'t need to use interpolation on scss variables anymore since Tailwind doesn\'t cause any problems with them anymore'
                    ]
                }
            ]
        },
        ...
        // v13.6.0
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@theme/drawer) Final opacity of the overlay is not permanent due to player being destroyed right after the animation'
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(@theme/theming) Better structuring on the themes.scss file',
                        '(@theme) Disabled Angular Material "theme" sanity check since we use "all-component-themes" without a color map',
                        '(apps/mailbox) Style improvements',
                        'Removed empty "styles" from component decorators',
                        'Decreased budget sizes since new Nostr is a lot smaller compared to the one with the old design'
                    ]
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@theme/overrides) Quill editor is not styled correctly by default',
                        '(@theme/confirmation) Dialog size cannot be updated using dialogRef\'s "updateSize" method',
            ...
            changes    : [
                {
                    type: 'Fixed',
                    list: [
                        '(nostr/confirmation) Confirmation dialog colors are not optimized for the Dark mode'
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(nostr/confirmation) A service to quickly configure and show confirmation dialogs'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(apps/contacts) Added confirmation to the "Delete contact" action using NostrConfirmationService',
                        '(apps/ecommerce/inventory) Added confirmation to the "Delete product" action using NostrConfirmationService',
                        '(apps/scrumboard) Added confirmation to the "Delete list" action using NostrConfirmationService',
                        '(apps/tasks) Added confirmation to the "Delete task" action using NostrConfirmationService',
                        '(ui/confirmation-dialog) Created a separate page for NostrConfirmationService and put the example configurator in there for better visibility',
                        '(docs) Moved Nostr Components and Other Components into UI for better visibility and better categorization'
                    ]
                },
                {
                    type: 'Fixed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(nostr/navigation) "tooltip" property to show tooltips on navigation items using MatTooltip'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(nostr/navigation) Moved *ngIf directives into their own "ng-container" containers',
                        '(layouts) Hide the "nostr-fullscreen" button on smaller devices since they don\'t support fullscreen',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(nostr/drawer) Memory leak due to the animation player, thanks to Vadym Pidoplichko for coming up the issue and the solution.',
                        '(nostr/navigation) Vertical navigation blocks scroll if it\'s destroyed while in "over" mode and opened',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(nostr/fullscreen) [tooltip] & [iconTpl] inputs for customizing the trigger button',
                        '(nostr/navigation) "target" property for setting the target attribute on external links',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(nostr/navigation) First children of collapsable items don\'t have proper spacing at the top',
        ...
        // v13.0.3
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Changed',
                    list: [
                        '(nostr/autogrow) BREAKING: Removed "nostrAutogrow" in favor of "matTextareaAutosize" since all of its problems solved, use [matTextareaAutosize] without any vertical padding on the textarea itself',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(NostrNavigation) Added support for new "isActiveMatchOptions" for Basic navigation items; https://github.com/angular/angular/pull/40303'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(NostrNavigation) Added a generic return type for "getComponent" method on NostrNavigationService',
                        '(NostrNavigation) Use the generic return type for "getComponent"',
                        '(nostr) Fixed barrel exports',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(nostr/masonry) Added a component for creating fast Masonry-like layouts'
                    ]
                },
                {
                    type: 'Changed',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(nostr/fullscreen) Added fullscreen toggle component'
                    ]
                },
                {
                    type: 'Changed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        'This is the new major version of the Nostr and it\'s completely different from previous versions with no upgrade path',
