...
export class MailboxSidebarComponent implements OnInit, OnDestroy
{
    ...
    private _filtersMenuData: NostrNavigationItem[] = [];
    private _foldersMenuData: NostrNavigationItem[] = [];
    private _labelsMenuData: NostrNavigationItem[] = [];
    private _otherMenuData: NostrNavigationItem[] = [];
    ...
    private _generateFoldersMenuLinks(): void
    {
        ...
        this.folders.forEach((folder) => {
            ...
            const menuItem: NostrNavigationItem = {
                id   : folder.id,
                title: folder.title,
                type : 'basic',
                icon : folder.icon,
    ...
    private _updateNavigationBadge(folders: MailFolder[]): void
    {
        ...
        const mainNavigationComponent = this._nostrNavigationService.getComponent<NostrVerticalNavigationComponent>('mainNavigation');

        // If the main navigation component exists...
        if ( mainNavigationComponent )
        {
            const mainNavigation = mainNavigationComponent.navigation;
            const menuItem = this._nostrNavigationService.getItem('apps.mailbox', mainNavigation);
