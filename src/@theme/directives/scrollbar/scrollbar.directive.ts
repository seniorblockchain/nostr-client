 ...
 */
@Directive({
    selector: '[nostrScrollbar]',
    exportAs: 'nostrScrollbar'
})
export class NostrScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_nostrScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() nostrScrollbar: boolean = true;
    @Input() nostrScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'nostrScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.nostrScrollbar = coerceBooleanProperty(changes.nostrScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.nostrScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'nostrScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.nostrScrollbarOptions.currentValue);
