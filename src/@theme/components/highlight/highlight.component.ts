...
import { NostrHighlightService } from '@theme/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[nostr-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'nostrHighlight'
})
export class NostrHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _nostrHighlightService: NostrHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._nostrHighlightService.highlight(this.code, this.lang));
