...
import { NostrMockApiReplyCallback } from '@theme/lib/mock-api/mock-api.types';

export class NostrMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: NostrMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: NostrMockApiReplyCallback): void
    {
        // Store the reply
