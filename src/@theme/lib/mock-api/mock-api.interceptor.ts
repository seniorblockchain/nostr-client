...
export class NostrMockApiInterceptor implements HttpInterceptor
{
    /**
     * Constructor
     */
    constructor(
        @Inject(NOSTR_MOCK_API_DEFAULT_DELAY) private _defaultDelay: number,
    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>>
    {
        ...
        const {
                  handler,
                  urlParams
              } = this._nostrMockApiService.findHandler(request.method.toUpperCase(), request.url);
